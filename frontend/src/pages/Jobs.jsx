    ...
    <div className="p-10 min-h-screen">
      ...
      <div className="mb-12">
        ...
        <p className="text-on-surface-variant text-lg max-w-2xl font-medium opacity-70">
          Gérez vos cycles de recrutement et identifiez les meilleurs talents grâce à l'IA Luminary.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
        <div className="md:col-span-2 bg-surface-container-lowest p-8 rounded-3xl shadow-ambient relative overflow-hidden group">
          ...
          <p className="text-sm font-bold text-primary tracking-widest uppercase mb-4">Pipeline total</p>
          ...
          <p className="text-on-surface-variant text-sm mt-4 font-medium">18 départements actifs</p>
        </div>

        <div className="bg-surface-container-lowest p-8 rounded-3xl shadow-ambient">
          <p className="text-sm font-bold text-on-surface-variant/60 tracking-widest uppercase mb-4">Score moyen IA</p>
          ...
          <p className="text-on-surface-variant text-sm mt-4 font-medium">Performance excellente</p>
        </div>

        <div className="bg-primary-container p-8 rounded-3xl shadow-lg text-on-primary-container">
          <p className="text-sm font-bold tracking-widest uppercase mb-4 opacity-80">Entretiens aujourd'hui</p>
          <div className="text-5xl font-black">12</div>
          <p className="text-sm opacity-70 mt-4 font-medium">Sur tous les postes</p>
        </div>
      </div>
          ...
          <div key={i} className={`bg-surface-container-lowest rounded-3xl p-8 shadow-ambient hover:shadow-ambient-lg transition-all group flex flex-col h-full cursor-pointer ${job.draft ? 'opacity-60' : ''}`}>
            ...
            <div className="mt-auto">
              <div className="flex justify-between items-end mb-2">
                <p className="text-xs font-bold text-on-surface-variant">Étape de recrutement</p>
